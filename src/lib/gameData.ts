...
export type RankEntry = { name: string; minScore: number; icon: string };
export const RANKS: RankEntry[] = [
  { name: "Junior Detective", minScore: 0, icon: "🔍" },
  { name: "Case Cracker", minScore: 40, icon: "🕵️" },
  { name: "Master Sleuth", minScore: 80, icon: "🏆" },
  { name: "Detective Legend", minScore: 120, icon: "⭐" },
];
